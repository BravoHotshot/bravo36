...
[_NAV] = LAYOUT_split_3x5_3(
  ...
  KC_F11,  KC_F12,  KC_UP,   KC_PGUP, KC_PGDN,      KC_END,  KC_HOME, XXXXXXX, XXXXXXX, XXXXXXX,
  XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, KC_TAB,       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                    _______, KC_DEL,  _______,      _______, NAV_ADJ, _______
),

[_NUM] = LAYOUT_split_3x5_3(
  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,         KC_6,    KC_7,    KC_8,    KC_9,    KC_0,
  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,      KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN,
  KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,      KC_PIPE, KC_LCBR, KC_RCBR, KC_UNDS, KC_PLUS,
